package com.example.bitebook_new.adapter;
...
public class PlaceAutoSuggestAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {
    ...
    private List<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        ...
        RectangularBounds bounds = RectangularBounds.newInstance(
                new LatLng(-1.266744, 103.617056),
                new LatLng(1.456811, 104.026273));
